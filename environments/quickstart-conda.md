...
## Being Clean
Conda downloads get big - lots of packages, lots of files, lots of space. Can grow to 10s of GB across a system. You can remove unused packages (e.g. downloaded for environments that no longer exist) with `conda clean --all`. Can take a while but saves potentially 10s of GB!
